...
def test_ec2_app_policy_is_least_privilege_on_one_bucket() -> None:
    ...
    assert all("poc-cloud-foundation-lab-data" in r for r in resources)
    assert not any(r == "*" for r in resources)


def test_bucket_policy_principal_is_instance_role() -> None:
    role_arn = "arn:aws:iam::000000000000:role/poc-cloud-foundation-lab-ec2"
    doc = _render_tftpl(
